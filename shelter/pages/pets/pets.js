...
let current_page = 1;
  ...
  function get_current_items(index) {
    const catalog = document.querySelector('.our-friends__list');
  ...
  get_current_items(current_page-1);

  document.addEventListener('click', function(evt) {
    if (evt.target.parentNode.classList.contains('our-friends__item') || evt.target.classList.contains('our-friends__item')) {
      let current_name;
      if (evt.target.parentNode.classList.contains('our-friends__item')) {
        current_name = evt.target.parentNode.querySelector('.our-friends__name').innerHTML;
      } else if (evt.target.classList.contains('our-friends__item')) {
        current_name = evt.target.querySelector('.our-friends__name').innerHTML;
      }
  ...
  let btn_first = document.querySelector('.our-friends__btn--first');
  let btn_previous = document.querySelector('.our-friends__btn--previous');
  let btn_current = document.querySelector('.our-friends__btn--current');
  let btn_next = document.querySelector('.our-friends__btn--next');
  let btn_last = document.querySelector('.our-friends__btn--last');
  btn_first.addEventListener('click', function() {
    ...
    get_current_items(current_page-1);
    btn_current.innerHTML = current_page;
  });
